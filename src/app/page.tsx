          ...
          <div className="flex items-center gap-3">
            {portfolio.contact.linkedin && (
              <a href={portfolio.contact.linkedin} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d1117] border border-[#21262d] text-[#8b949e] hover:text-blue-400 hover:border-blue-500/50 transition-all duration-200"
                title="LinkedIn"
              >
            ...
            {portfolio.contact.github && (
              <a href={portfolio.contact.github} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d1117] border border-[#21262d] text-[#8b949e] hover:text-white hover:border-[#8b949e] transition-all duration-200"
                title="GitHub"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {portfolio.contact.cv && (
              <a href={portfolio.contact.cv} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#0d1117] border border-[#21262d] text-[#8b949e] hover:text-purple-400 hover:border-purple-500/50 transition-all duration-200"
                title="CV"
              >
