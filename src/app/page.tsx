      ...
      <section className="flex flex-col md:flex-row items-center gap-6 pt-4">
        ...
        <div className="anim-photo shrink-0 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-xs text-[#8b949e] uppercase tracking-widest font-medium">Me contacter</p>
            <div className="flex items-center gap-2">
              {portfolio.contact.linkedin && (
                <a href={portfolio.contact.linkedin} target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#0A66C2] text-white hover:opacity-85 transition-opacity duration-200"
                  title="LinkedIn"
                >
              ...
              {portfolio.contact.github && (
                <a href={portfolio.contact.github} target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#24292e] text-white hover:opacity-85 transition-opacity duration-200"
                  title="GitHub"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {portfolio.contact.cv && (
                <a href={portfolio.contact.cv} target="_blank" rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-purple-600 text-white hover:opacity-85 transition-opacity duration-200"
                  title="CV"
                >
