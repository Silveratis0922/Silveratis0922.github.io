  ...
  return (
    <div className="space-y-20">
      ...
      <section className="flex flex-col md:flex-row items-center gap-6 pt-4">
        ...
        {/* Photo + icônes */}
        <div className="anim-photo shrink-0 flex flex-col items-center gap-4">
          ...
          {/* Icônes réseaux */}
          <div className="relative border border-[#30363d] rounded-xl px-4 py-3 pt-5">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2 bg-[#0a0e1a]">
              <span className="text-xs text-[#8b949e] uppercase tracking-widest font-medium whitespace-nowrap">Me contacter</span>
            </div>
            <div className="flex items-center gap-2">
              {portfolio.contact.linkedin && (
                <a href={portfolio.contact.linkedin} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#0A66C2] text-white hover:opacity-85 transition-opacity duration-200"
                  title="LinkedIn"
                >
              ...
              {portfolio.contact.github && (
                <a href={portfolio.contact.github} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#24292e] text-white hover:opacity-85 transition-opacity duration-200"
                  title="GitHub"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {portfolio.contact.cv && (
                ...
                >
                  ...
                  <span className="text-[9px] font-bold leading-none">CV</span>
                </a>
              )}
            </div>
          </div>
